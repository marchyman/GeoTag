...
struct LatitudeStyle: ParseableFormatStyle {
    ...
    func format(_ value: Double?) -> String {
        return coordToString(for: value, ref: latRef)
    }
}
...
struct LongitudeStyle: ParseableFormatStyle {
    ...
    func format(_ value: Double?) -> String {
        return coordToString(for: value, ref: lonRef)
    }
}
...
extension String {
    ...
    func validateLatitude() -> Double? {
        return try? validateCoord(range: 0...90, reference: latRef)
    }

    func validateLongitude() -> Double? {
        return try? validateCoord(range: 0...180, reference: lonRef)
    }
