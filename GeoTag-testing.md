...
- [x] Select View -> Pin view options -> Show pins for all selected items
   Verify multiple pins on the map
   Verify one pin is red
   Verify other pins have a yellow center.

- [x] Cmd-Click on the most selected item to deselect it.
...
- [x] Launch GeoTag
   ...
   Cycle through the Map Style options in the context menu.
   Verify the map changes.
   Set the style to Hybrid.
   Use the map search bar to select some location.
   Verify the search worked.
   Click on the map search bar. Verify the search was added to recent searches.
...
- [x] Lauch GeoTag
   ...
   Select various images and verify their thumbnail is displayed
   Verify image locations are shown on the map
   Delete an image location from one of the images
   Save the changes
   Use cmd-K to clear the image list
